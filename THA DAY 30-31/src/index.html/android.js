...
const Android  = () => {
    const cards = [
        ...
        },
        {
            ...
            desc: " Android App Development for complete beginners, make beautiful apps, get a job , Java AND Kotlin!",
            price: "₹799",
            cutprice:"₹2,999",
            rating: "★★★★★",
  ...
  return (
      <div className="App">
         <h1 class="heading">
        <span>Courses On Andriod Development</span>
      </h1>
